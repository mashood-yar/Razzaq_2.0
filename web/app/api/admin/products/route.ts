...
export async function POST(request: NextRequest) {
  ...
  try {
    ...
    const { name, description, sku, price_pkr, stock_quantity, category_id, weight_kg, status, images } = body as { name: string; description: string; sku: string; price_pkr: string; stock_quantity: string; category_id: string; weight_kg?: string; status: string; images?: Array<{ url: string }> };
