...
export default function AuthLayout({ children }: { children: ReactNode }) {
  return (
    <div className="relative min-h-[calc(100vh-8rem)] overflow-hidden bg-ocean-deep px-4 py-16">
      ...
      <div className="relative mx-auto flex w-full max-w-md flex-col justify-center">
        <div className="rounded-[2rem] border border-border-subtle/80 bg-ocean-surface/95 p-8 shadow-ocean backdrop-blur-sm sm:p-10">
          {children}
        </div>
      </div>
    </div>
